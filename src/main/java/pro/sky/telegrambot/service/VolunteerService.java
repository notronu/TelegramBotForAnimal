...
import pro.sky.telegrambot.model.PetReportSessions;
...
public class VolunteerService {
    ...
    private final List<PetReportSessions> petReportSessions = new ArrayList<>();
    ...
    public int addPetReport(String name, String diet, String health, String habits, String photoPath) {
        int petId = petCounter.getAndIncrement();
        PetReportSessions petSession1 = new PetReportSessions(petId, name, diet, health, habits, photoPath);
        petReportSessions.add(petSession1);
        return petId;
    }
